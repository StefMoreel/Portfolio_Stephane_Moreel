...
export default function Skills() {
  ...
  if (loading) return <section className="py-10 text-center text-gray-400">Chargement…</section>
  if (error)   return <section className="py-10 text-center text-red-400">Erreur: {error}</section>
