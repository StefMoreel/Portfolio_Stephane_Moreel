...
function Contact() {
  ...
  return (
    <section className="bg-black md:bg-gradient-yellow py-10" id="contact">
      <div>
        <h3 className="text-[24px] font-bold md:text-[32px] ">
          Contactez-<span className="text-yellow md:text-white">Moi</span>
        </h3>
      </div>
      <div className="mt-10 mx-8 md:mx-50 lg:mx-50 xl:mx-96">
      ...
      <h3 className="text-center text-[16px] lg:text-2xl font-bold m-4 lg:m-10">
        Ou contactez-<span className="text-yellow md:text-white">moi </span>sur
      </h3>
