function SkillCard({title, subtitle, description, icons}) {
    return ( 
        <div className="flex flex-col justify-center bg-gradient-to-b from-black to-grey p-3 mx-8 md:mx-0 rounded-lg shadow-lg text-center border-2 border-yellow hover:border-blue transition duration-300">
