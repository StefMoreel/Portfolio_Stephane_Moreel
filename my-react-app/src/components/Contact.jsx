        ...
        <section id="contact">
            ...
            <div className="mt-4 mx-8">
                <form action="https://formspree.io/f/mayvlrdo" method="POST" className="flex flex-col gap-4">
                    <input type="text" name="name" placeholder="Votre nom" className="font-bold border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow" required />
                    <input type="email" name="email" placeholder="Votre email" className="font-bold border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow" required />
                    <textarea name="message" rows="5" placeholder="Votre message" className="font-bold border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow" required></textarea>
